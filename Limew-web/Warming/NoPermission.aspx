<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Limew.Default" %>
...
<script language="javascript" type="text/javascript">
    ...
    Ext.onReady(function() {
        ...
        ExtNoPermission.logonUrl = '<%= Page.ResolveUrl(Limew.Parameter.Config.ParemterConfigs.GetConfig().LogonPage) %>';
