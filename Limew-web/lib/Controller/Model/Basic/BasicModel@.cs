...
namespace Limew.Model.Basic
{
    public partial class BasicModel
    {
        ...
        public IList<Limew.Model.Basic.Table.Record.AttendantV_Record> getAttendantV_By_Company_Account_Password(string pCompanyName, string pAccount, string pPassword)
        {
            try
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
        ...
        public IList<Limew.Model.Basic.Table.Record.AttendantV_Record> getAttendantV_By_Company_Account_Password(string pCompanyName, string pAccount)
        {
            try
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
        ...
        public System.Data.DataTable getDepartment_By_ParentUuid(string pParentUuid)
        {
            try
            {
                ...
                var result = department.Where(new SQLCondition(department)
                    ...
                    .FetchAll();
                //.FetchAll<Limew.Model.Basic.Table.Record.Department_Record>();
                return result;
            }
            catch (Exception ex)
            {
        ...
        public Int32 getGroupHead_ByParam_Count(string company_uuid, string application_head_uuid, List<string> group_head_list, string searchkey)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.GroupHeadV table = new Limew.Model.Basic.Table.GroupHeadV(dbc);
        ...
        public IList<GroupAttendantV_Record> getGroupAttendantBy(string application_head_uuid, string company_uuid, string attendant_uuid)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.GroupAttendantV table = new Limew.Model.Basic.Table.GroupAttendantV(dbc);
        ...
        public IList<GroupAttendant_Record> getGroupAttendantByGroupHeadUuid(string group_head_uuid)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.GroupAttendant table = new Limew.Model.Basic.Table.GroupAttendant(dbc);
            ...
            (string pAppmenuUuid, string pGroupHeadUuid)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.GroupAppmenu groupAppMenuv = new Limew.Model.Basic.Table.GroupAppmenu(dbc);
                var result = groupAppMenuv.Where(new SQLCondition(groupAppMenuv)
                    .Equal(groupAppMenuv.GROUP_HEAD_UUID, pGroupHeadUuid)
                    .And()
        ...
        {
            dbc = LK.Config.DataBase.Factory.getInfo();
            Limew.Model.Basic.Table.AuthorityMenuV table = new Limew.Model.Basic.Table.AuthorityMenuV(dbc);
        ...
        {
            dbc = LK.Config.DataBase.Factory.getInfo();
            Limew.Model.Basic.Table.ErrorLogV table = new Limew.Model.Basic.Table.ErrorLogV(dbc);
            SQLCondition con = new SQLCondition(table)
        ...
        public int getVAppmenuProxyMap_Count(string pApplicationHeadUuid, string pAppmenuUuid, string pKeyWord)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.VAppmenuProxyMap table = new Limew.Model.Basic.Table.VAppmenuProxyMap(dbc);
        ...
        public IList<VAuthProxy_Record> getVAuthProxy_By_AttendantUuid(string pAttendantUuid)
        {
            ...
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
                Limew.Model.Basic.Table.VAuthProxy vauthproxy = new Limew.Model.Basic.Table.VAuthProxy(dbc);
        ...
        public IList<Limew.Model.Basic.Table.Record.AttendantV_Record> getAttendantV_By_Company_Account_Password_FormDomain(string pCompanyName, string pAccount, string pPassword, string pDomain)
        {
            try
            {
                dbc = LK.Config.DataBase.Factory.getInfo();
