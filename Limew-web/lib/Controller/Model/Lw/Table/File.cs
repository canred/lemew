...
namespace Limew.Model.Lw.Table
{
	...
	private IList<File_Record> _All_Record = new List<File_Record>();
		...
		public void UpdateAllRecord() {
			try{
				UpdateAllRecord<File_Record>(this.AllRecord());   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
		...
		public void UpdateAllRecord(DB db) {
			try{
				UpdateAllRecord<File_Record>(this.AllRecord(),db);   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
		...
		public void InsertAllRecord() {
			try{
				InsertAllRecord<File_Record>(this.AllRecord());   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
		...
		public void InsertAllRecord(DB db) {
			try{
				InsertAllRecord<File_Record>(this.AllRecord(),db);   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
		...
		public void DeleteAllRecord() {
			try{
				DeleteAllRecord<File_Record>(this.AllRecord());   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
		...
		public void DeleteAllRecord(DB db) {
			try{
				DeleteAllRecord<File_Record>(this.AllRecord(),db);   
			}
			catch (Exception ex){
				log.Error(ex);LK.MyException.MyException.Error(this, ex);
				throw ex;
