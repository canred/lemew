...
namespace Limew
{
    ...
    public class BaseAction
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Limew.Model.Basic.Table.Record.AttendantV_Record getUser()
        {
            if (ss.ExistKey("USER"))
            {
        ...
        public CheckUserStatus checkUser(System.Web.HttpRequest httpRequest)
        {
            if (this.getUser() == null)
            {
                if (httpRequest.Headers["CLOUD_ID"] != null)
                {
                    ...
                    Limew.Model.Basic.BasicModel bmod = new BasicModel();
                    IList<Limew.Model.Basic.Table.Record.ActiveConnection_Record> drsAc = new List<Limew.Model.Basic.Table.Record.ActiveConnection_Record>();
