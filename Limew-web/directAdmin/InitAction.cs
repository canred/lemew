...
public class InitAction : BaseAction
{
    ...
    public JObject loadParameter(Request request)
    {
        ...
        { /*權限檢查*/
            ...
            dt.AcceptChanges();
            var row = dt.NewRow();
            row["AppName"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().AppName;
            row["AuthenticationType"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().AuthenticationType;
            row["EnableGuestLogin"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().EnableGuestLogin.ToString().ToLower();
            row["GuestCompany"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().GuestCompany;
            row["GuestAccount"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().GuestAccount;
            row["IsProductionServer"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().IsProductionServer.ToString().ToLower();
            row["DefaultPage"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DefaultPage;
            row["LogonPage"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().LogonPage;
            row["WebRoot"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().WebRoot;
            row["DEVUserCompany"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DEVUserCompany;
            row["DEVUserAccount"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DEVUserAccount;
            row["DEVUserPassword"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DEVUserPassword;
            row["NoPermissionPage"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().NoPermissionPage;
            row["UploadFolder"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().UploadFolder;
            row["Title"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().Title;
            row["SystemIcon"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().SystemIcon;
            row["CompanyImage"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().CompanyImage;
            row["SystemName"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().SystemName;
            row["SystemDescription"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().SystemDescription;
            row["SystemFoolter"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().SystemFoolter;
            row["InitCompany"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().InitCompany;
            row["InitCompanyUuid"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().InitCompanyUuid == "" ? LK.Util.UID.Instance.GetUniqueID() : Limew.Parameter.Config.ParemterConfigs.GetConfig().InitCompanyUuid;
            row["InitAdmin"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAdmin;
            row["InitAdminUuid"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAdminUuid == "" ? LK.Util.UID.Instance.GetUniqueID() : Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAdminUuid;
            row["InitAppUuid"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAppUuid == "" ? LK.Util.UID.Instance.GetUniqueID() : Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAppUuid;
            row["LogoutPage"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().LogoutPage;
            row["DirectApplicationName"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName;
            row["DirectTimeOut"] = Limew.Parameter.Config.ParemterConfigs.GetConfig().DirectTimeOut.ToString();
            /*使用Store Std out 『Sotre物件標準輸出格式』*/
                ...
                while ((tmpKey = tr.ReadLine()) != null)
                {
                    ...
                    switch (tmpKey)
                    {
                        case "{admin}":
                            ...
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAdmin);
                            }
                            break;
                        case "{admin_uuid}":
                            if (ht.ContainsKey(tmpKey) == false)
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAdminUuid);
                            }
                            break;
                        case "{application_name}":
                            if (ht.ContainsKey(tmpKey) == false)
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().AppName);
                            }
                            break;
                        case "{application_head_uuid}":
                            if (ht.ContainsKey(tmpKey) == false)
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().InitAppUuid);
                            }
                            break;
                        case "{company}":
                            if (ht.ContainsKey(tmpKey) == false)
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().InitCompany);
                            }
                            break;
                        case "{company_uuid}":
                            if (ht.ContainsKey(tmpKey) == false)
                            {
                                ht.Add(tmpKey, Limew.Parameter.Config.ParemterConfigs.GetConfig().InitCompanyUuid);
                            }
                            break;
                        default:
                            if (ht.ContainsKey(tmpKey) == false)
