...
Ext.onReady(function () {
    ...
    ExtLogon = Ext.widget({
        ...
        layout: 'form',
        id: 'ExtLogonForm',
        url: '<%= Page.ResolveUrl(Limew.Parameter.Config.ParemterConfigs.GetConfig().NoPermissionPage) %>',
        urlSuccess: '',
        urlFail: '',
        frame: true,
    ...
    ExtLogon.width = "100%";
    ExtLogon.urlSuccess = '<%= Page.ResolveUrl(Limew.Parameter.Config.ParemterConfigs.GetConfig().DefaultPage)%>';
    ExtLogon.urlFail = '<%= Page.ResolveUrl(Limew.Parameter.Config.ParemterConfigs.GetConfig().NoPermissionPage)%>';
    ExtLogon.title = '<img src="' + SYSTEM_ROOT_PATH + '/css/custimages/login.gif" style="height:16px;margin-bottom:4px;margin-right:10px;" align="middle"><%= Limew.Parameter.Config.ParemterConfigs.GetConfig().SystemName%>';
