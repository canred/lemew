...
namespace Limew.js
{
    ...
    public class System_Config : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (systemConfig == null || Limew.Parameter.Config.ParemterConfigs.GetConfig().IsProductionServer == false)
            {
                ...
                srJs.Close();
                jsContext += "SYSTEM_APPLICATION='" + Limew.Parameter.Config.ParemterConfigs.GetConfig().DirectApplicationName + "';";
