<%@ Page Title="" Language="C#" MasterPageFile="~/mpStand.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="Limew.Logout" EnableViewState="false"  %>
    ...
    ExtLogout = Ext.widget({
        ...
        items: [{
            ...
            items: [{
                ...
                flex: 1,
                handler: function () {
                    location.href = '<%= Page.ResolveUrl(Limew.Parameter.Config.ParemterConfigs.GetConfig().LogonPage) %>';
                }
            }, {
                xtype: 'label',
                flex: 1
