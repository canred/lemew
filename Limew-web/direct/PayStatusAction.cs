...
[DirectService("PayStatusAction")]
public class PayStatusAction : BaseAction
{
    ...
    public JObject loadPayStatus(string pKeyword, string pageNo, string limitNo, string sort, string dir, Request request)
    {
        ...
        {     /*Cloud身份檢查*/
            ...
            var totalCount = mod.getPayStatus_By_Keyword_Count(pKeyword);
            var data = mod.getPayStatus_By_Keyword(pKeyword, orderLimit);
            if (data.Count > 0)
            {
