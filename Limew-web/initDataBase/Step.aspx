<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step.aspx.cs" Inherits="Limew.initDataBase.Step" %>
...
Ext.onReady(function() {
    ...
    var pException = Ext.create('Ext.form.Panel', {
        title: 'Setting "Exception" DataBase',
        ...
        fbar: [{
            ...
            handler: function() {
                ...
                WS.InitAction.submitParameter(AppName, AuthenticationType, EnableGuestLogin, GuestCompany, GuestAccount, IsProductionServer, DefaultPage, LogonPage, WebRoot, NoPermissionPage, UploadFolder, Title, SystemIcon, CompanyImage, SystemName, SystemDescription, SystemFoolter,
                    InitCompany, InitCompanyUuid, InitAdmin, InitAdminUuid, InitAppUuid, LogoutPage, DevUserCompany, DevUserAccount, DevUserPassword, DirectApplicationName, DirectTimeOut,
                    function(objJson) {
                        Ext.getBody().unmask();
                        if (objJson.success) {
                            Ext.MessageBox.show({
